...
class FetchMyPendingRentalRequest
{
    public function fetchMyPendingRentalRequestCTRL(): void
    {
        ...
        $results = $model->fetchMyPendingRentRequest((int) $user_ID);
...
(new FetchMyPendingRentalRequest())->fetchMyPendingRentalRequestCTRL();