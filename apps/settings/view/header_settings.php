    ...
    <div class="header-top header-top-ptb-1 d-none d-lg-block">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-2">
                    <?php
                    echo isset($_SESSION["isLogin"]) ? "<h5><a href='dashboard'>My Account</a></h5>" : "<h5><a href='login'>Login/Signup</a></h5>";
                    ?>
                </div>
                    ...
                    <div class="main-menu main-menu-padding-1 main-menu-lh-2 d-none d-lg-block font-heading">
                        <nav>
                            <ul>
                                ...
                                <li>
                                    <?php
                                    echo isset($_SESSION["isLogin"]) ? "<a href='dashboard'>My Account</a>" : "<a href='login'>Login</a>";
                                    ?>
                                </li>
