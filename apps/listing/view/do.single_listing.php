...
$item_slug              = trim($_REQUEST['slg']);

$page_title             = "Rent " . $item_slug;
...
$instances_to_fetch_item_by_slug    = new FetchAllCTRL('assets', 'asset_images', 'asset_category', 'asset_sub_category');
$fetchAssetsBySlug                  = $instances_to_fetch_item_by_slug->fetchListingByThisSlugCTRL($item_slug);
// $fetchItem                          = $fetchAssetsBySlug->fetch(PDO::FETCH_ASSOC);
